...
/**
 * The main knockplop configuration form.
 *
 * @package     knockplop
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_knockplop_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('knockplopname', 'knockplop'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'knockplopname', 'knockplop');
        ...
        $mform->setDefault('room', substr(base64_encode(sha1(mt_rand())), 0, $CFG->knockplop_roomlength));
